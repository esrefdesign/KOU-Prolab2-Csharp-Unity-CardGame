...
public class CardSelectHandler : MonoBehaviour, IPointerClickHandler
{
    ...
    private spawnPlayerSlot spawnPlayerSlot; // Seçilen kartları yöneten ana script

    public void Initialize(Vector3[] targetPositions, bool[] positionOccupied, Savas_Araclari associatedCard, spawnPlayerSlot spawnPlayerSlot)
    {
        this.targetPositions = targetPositions;
        CardSelectHandler.positionOccupied = positionOccupied;
        this.associatedCard = associatedCard;
        this.spawnPlayerSlot = spawnPlayerSlot;
    ...
    {
        if (spawnPlayerSlot.selectedCards.Contains(associatedCard))
        {
            ...
            if (IsAtTargetPosition())
            {
                ...
                spawnPlayerSlot.RemoveSelectedCard(associatedCard);
            }
            else
            {
